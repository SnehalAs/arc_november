...
// import Globe from "./globe.png"; // Replace with the actual image path
...
//           <MediaItem src="" alt="Dailyhunt" />
//           <MediaItem src="{TOI}" alt="TOI" />
//           <MediaItem src="{times}" alt="Hindustan Times" />
//         </MediaContainer>
//       </Content>
...
import Globe from "./globe.png"; // Import the globe image
